...
class SubdomainFinder(BaseModule):
    def __init__(self):
        ...
        self.Description = (
            "Hedef domain için subdomain (alt alan adı) keşfi yapar (DNS Bruteforce)."
        )
        self.Author = "MahmutP"
    ...
    def run(self, options):
        ...
        print("[bold blue][*][/bold blue] Tarama başlatılıyor...")
        ...
        try:
            ...
            for sub in track(subdomains, description="Taranıyor..."):
                ...
                try:
                    ...
                    print(
                        f"[green][+][/green] Bulundu: [bold cyan]{target}[/bold cyan] -> {ip_address}"
                    )
            ...
            if found_subdomains:
                ...
                table = Table(
                    title=f"Subdomain Sonuçları ({domain})",
                    show_header=True,
