...
class Set(Command):
    ...
    def _set_completer(self, text: str, word_before_cursor: str) -> list[str]:
        ...
        # "set TEX" yazıldığında option isimlerini tamamla
            ...
            current_arg = parts[1]
            return sorted([name for name in options if name.startswith(current_arg)])
    ...
    def execute(self, *args: str, **kwargs: Any) -> bool:
        ...
        if option_name in options:
            ...
            print(
                f"Seçenek '{option_name}' bulunamadı. 'show options' ile mevcut seçenekleri listeleyebilirsiniz."
            )
            return False
